  ...
  const experiences = [
    {
      ...
      responsibilities: [
        'Implemented signature analysis in ICS environments to enhance threat detection by identifying and documenting malicious patterns.',
        'Created Python scripts for automated vulnerability scanning and web crawling, improving data collection speed and accuracy.',
        'Identified zero-day vulnerabilities and coordinated mitigation strategies using advanced research and tools.',
        'Provided risk-based security assessments and actionable insights to support stakeholder remediation efforts.',
        'Utilised OSINT tools to gather contextual threat intelligence and enhance vulnerability assessments with real-world data.'
      ],
    ...
    },
    {
      ...
      responsibilities: [
        'Served as primary security contact, managing threat monitoring, EDR triage, and policy implementation to strengthen systems.',
        'Led DLP incident response, conducted root cause analysis, and maintained audit-ready documentation.',
        'Improved detection by 50% with Microsoft Defender and reduced phishing cases by 75% through awareness training.',
        'Improved scanning tools and coverage, and implemented a RACI matrix to reduce the organization\'s risk score by half.',
        'Lead Implementor of ISO 27001 with no non-conformities and Worked as Auditor of CIS benchmark reviews to ensure policy compliance.'
      ],
    ...
    },
    {
      ...
      responsibilities: [
        'Conducted system configuration reviews and technical controls to identify vulnerabilities and harden virtual servers.',
        'Utilised open-source tools to collect, profile, and archive threat intelligence data through a custom Python tool.',
        'Conducted web application penetration testing using proxy environments and created detailed remediation documentation.'
      ],
      ...
      <div className="container-modern">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {exp.responsibilities.map((resp, respIndex) => (
                          <div key={respIndex} className="flex items-start gap-3 text-sm text-muted-foreground">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {exp.achievements.map((achievement, achIndex) => (
                            <Badge 
                              key={achIndex} 
                              variant="outline" 
                              className="text-xs px-3 py-1 border-primary text-primary"
                            >
                              {achievement}
                            </Badge>
                          ))}
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6 mb-20">
          {education.map((edu, index) => (
            <Card 
              key={index} 
              className="card-modern card-hover p-6 animate-fade-in-up"
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          {projects.map((project, index) => (
            <Card 
              key={index} 
              className="card-modern card-hover p-6 animate-fade-in-up group"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="space-y-4">
        ...
        <div className="text-center animate-fade-in">
          <Button className="btn-primary group" onClick={() => window.open('https://chaitravm.wordpress.com', '_blank')}>
